...
class State(HydraHeadApp):
    ...
    def load_graphs(self, state, state2, state3):
    ...
    def run(self):
        ...
        with col1:
            ...
            cursor.execute(state_accident_coordinates, state = state_selectbox1)
        ...
        self.load_graphs(state_selectbox1, state_selectbox2, state_selectbox3)
